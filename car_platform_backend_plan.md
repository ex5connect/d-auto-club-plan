...
- Backend lead is also handling Telegram Ads Distribution project for the first 2 weeks
- 2 backend developers will join after 2 months
- Hiring continues in parallel

### Frontend Team

- Some frontend developers are willing to learn backend
- Backend lead will conduct backend coding sharing sessions
- Frontend developers can help on simple backend CRUD modules after training
...
- Month 1 is a foundation month, but backend lead only has around 50% capacity because of the Telegram Ads Distribution project

---

# 5. 6-Month Backend Timeline

## Month 1 — Foundation + Training Preparation

### Main Reality

Backend lead has two responsibilities:

1. Finish Telegram Ads Distribution project
2. Start car platform backend foundation

Estimated allocation:

| Workstream | Estimate |
|---|---:|
| Telegram Ads Distribution | 2 weeks |
| Car Platform Foundation | 2 weeks |
...
- Prepare training materials for frontend team
...
Prepare basic training materials for frontend developers:

1. What is backend API?
2. Laravel request lifecycle
3. Route, controller, service, model
4. Migration and database basics
5. API validation
6. API response format
7. Simple CRUD example
8. How to test API using Postman
9. Git and pull request flow

### Suggested Training Sessions

#### Session 1 — Backend 101
...
- Frontend backend training materials prepared
- At least 1-2 backend sharing sessions completed

---

## Month 2 — Simple Modules + Frontend Backend Training

### Team Situation

- Backend lead is still the only full backend developer
- Frontend developers start helping with simple backend modules
- Backend lead reviews frontend developers' backend code
...
- Let frontend developers practice backend CRUD
...
- Frontend developers able to handle simple CRUD tasks
...
- Frontend developers continue assisting simple modules
...
- UAT can begin or complete depending on frontend readiness
...
These lower-priority modules are still part of full scope, but they should be assigned to frontend developers learning backend or junior backend developers because the logic is simpler.
...
## 4. Frontend Developers Helping Backend

This can work well if tasks are simple and standards are clear.
...
3. Create API standards
4. Prepare training material
5. Train frontend developers

## Month 2

Frontend developers start helping on:
...
4. Review code from frontend developers
...
|---|---|---|
| Month 1 | Foundation + training preparation | Auth, user, roles, API standard, training material |
| Month 2 | Simple modules + frontend backend practice | Community, workshop, car plate, review/report, My Cars |
...
> The backend plan targets full Figma scope completion in 6 months. Month 1 is used for backend foundation and frontend backend training while the backend lead completes the Telegram Ads Distribution project. Month 2 allows frontend developers to assist with simple backend modules. From Month 3 onward, the new backend developers join and the team focuses on core marketplace, commerce, admin, and launch preparation.
